...
export async function POST(request: NextRequest) {
  ...
  const martName = 'dim_transactions';
  ...
  try {
    ...
    const sqlPath = path.join(process.cwd(), 'analytics/sql/marts/dim_transactions.sql');
    ...
    // Revalidate analytics transactions API and page
    revalidatePath('/api/analytics/transactions');
