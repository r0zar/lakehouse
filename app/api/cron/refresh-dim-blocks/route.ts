...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const sqlPath = path.join(process.cwd(), 'analytics/sql/marts/dim_blocks.sql');
    ...
    // Revalidate analytics blocks API and page
    revalidatePath('/api/analytics/blocks');
    revalidatePath('/block-analytics');
